...
public class XRecyclerView extends RecyclerView {
    ...
    /**
     * must be set after using the adapter
     * @param footerClick
     */
    public void setFooterClick(OnClickListener footerClick){
        mFootViews.get(0).setOnClickListener(footerClick);
    }
