package adult.mas.com.thirdviewmodel.view.xrecycleview;
...
import adult.mas.com.thirdviewmodel.view.xrecycleview.progressindicator.AVLoadingIndicatorView;
...
public class LoadingMoreFooter extends LinearLayout {
        ...
        switch (state) {
            ...
            case STATE_CLICK_LOAD:
                if (isLoadMoreClickStyle) {
                    mText.setText(concatString(clickLoadDesc, getResources().getString(R.string.click_more_flag)));
                } else {
                    mText.setText(getResources().getString(R.string.nomore_loading));
                }
                progressCon.setVisibility(View.GONE);
    ...
    public String concatString(String... mParams) {
