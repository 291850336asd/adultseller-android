...
import adult.mas.com.imageload.progress.OnGlideImageViewListener;
import adult.mas.com.imageload.progress.OnProgressListener;
import adult.mas.com.imageload.progress.ProgressManager;
import adult.mas.com.imageload.transformation.GlideCircleTransformation;
...
public class GlideImageLoader {
    ...
    public void loadImageDefalutDra(String url, int placeholderResId) {
        load(url, requestOptionsDefultDra(placeholderResId));
    }

    public RequestOptions requestOptionsDefultDra(int placeholderResId) {
        return new RequestOptions()
                .placeholder(getContext().getResources().getDrawable(placeholderResId))
                .error(getContext().getResources().getDrawable(placeholderResId));
    }
